...
title_zh: 双序参量系统中超辐射基于普适临界标度率增强和抑制费米子配对
authors: Yilun Xu
date: 2026-04-08
...
tldr: 本研究探讨了具有两个或多个序参量的复杂系统中序参量间的相互影响，重点分析了超辐射如何调节费米子配对。基于朗道连续相变理论，作者推导出一种通用的自由能公式和物理量，用于确定序参量的变化率。通过研究双模Rabi模型和一维费米Dicke模型，证明了超辐射相变能增强或抑制双自旋配对强度和超导能隙，为多序参量系统的调控提供了新范式。
selection_source: fresh_fetch
motivation: 旨在揭示多序参量系统中一个序参量的相变如何影响另一个序参量的强度及其复杂的相图演化。
method: 基于朗道连续相变理论，利用通用的自由能公式推导出决定两个序参量变化率的通用物理量。
result: 在双模Rabi和一维费米Dicke模型中验证了超辐射相变对双自旋配对强度和超导能隙的调控作用。
conclusion: 该研究为多序参量复杂系统提供了新的研究范式，并为通过序参量间的相互作用增强或抑制特定物理效应开辟了新途径。
---

## 摘要
与单序参量系统不同，由两个或多个序参量描述的系统会表现出更复杂且更丰富的相图和临界现象。在双序参量系统中，一个序参量的相变可能会影响另一个序参量的强度。聚焦于朗道连续相变理论，我们基于自由能的通用公式，给出了一个决定两个序参量变化率的通用物理量。以双模 Rabi 模型和一维费米 Dicke 模型为例，我们验证了我们的解析结果，并展示了超辐射相变如何操纵双自旋配对强度和超导能隙。我们的工作提出了研究具有两个或多个序参量的复杂系统的新范式，并为通过这种相互作用增强或抑制所需的物理效应提供了新途径。
